...
def _clusters():
    return [
        ...
        },
        {
            ...
            "members": ["d", "e"],
            "indices": [3, 4],
            "group_impressions": 1000,
        },
        {"size": 1, "cohesion": 1.0, "representative": "f", "members": ["f"], "indices": [5]},
    ]
...
class TestHybrid(unittest.TestCase):
    ...
    def test_differentiate_json_sujo_nao_quebra(self):
        ...
        diffed = differentiate_clusters(
            _clusters(), pages, FakeClient("sem json aqui"), max_clusters=1
        )
