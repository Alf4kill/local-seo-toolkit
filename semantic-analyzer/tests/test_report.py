...
class TestLlmHtml:
    ...
    def test_veredito_spun_tem_badge_e_base(self):
        c = {"llm": {"verdict": "spun", "base_recomendada": "pagina-a",
                     "resumo": "quase iguais", "lacunas": ["faltam dados"]}}
        out = _llm_html(c)
        assert "SPUN" in out
...
class TestDiffHtml:
    ...
    def test_monta_linha_por_pagina(self):
        c = {"diff": {"paginas": [
            {"papel": "cabeca", "slug": "a", "keyword_alvo": "kw1",
             "intencao": "informacional", "titulo": "Titulo A", "foco": "foco A"},
            {"papel": "spoke", "slug": "b", "keyword_alvo": "kw2",
             "intencao": "transacional", "titulo": "Titulo B", "foco": "foco B"},
        ]}}
        out = _diff_html(c)
    ...
    def test_omitidas_viram_aviso_canonical(self):
        c = {"diff": {"paginas": [
                {"papel": "cabeca", "slug": "a", "keyword_alvo": "kw",
...
class TestGenerateHtml:
    ...
    def _clusters(self):
        return [
            {"size": 3, "cohesion": 0.91, "representative": "b",
             "members": ["a", "b", "c"]},
            {"size": 1, "cohesion": 1.0, "representative": "z",
             "members": ["z"]},
        ]
    ...
    def test_escapa_membros(self):
        clusters = [{"size": 2, "cohesion": 0.9, "representative": "x",
                     "members": ["x", "<b>y</b>"]}]
